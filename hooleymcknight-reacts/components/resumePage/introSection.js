  ...
  return (
    <div className="intro-section">
      <div className="intro-text">
        ...
        <a href="mailto:hooleymcknight.codes@gmail.com?subject=Hello Holly!&body=I'd love to connect with you..." alt="email address: hooleymcknight.codes@gmail.com">hooleymcknight.codes@gmail.com</a>
