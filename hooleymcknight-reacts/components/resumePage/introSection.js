  ...
  return (
    <div className="intro-section">
      <div className="intro-text">
        ...
        <a href="mailto:hollyphillips.dev@gmail.com?subject=Hello Holly!&body=I'd love to connect with you..." alt="email address: hollyphillips.dev@gmail.com">hollyphillips.dev@gmail.com</a>
