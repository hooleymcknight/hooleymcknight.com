...
const getTargetYear = (selectedMonth) => {
...
const monthChange = (e) => {
  ...
  if (month) {
    const daySelect = month.closest('form#time-conversion').querySelector('select#day')
...
const formSubmit = (e) => {
  ...
  if (form) {
    ...
    results.querySelector('b').innerText = liveTime
    results.setAttribute('shown', 'true')
  }
}

export { monthChange, formSubmit }